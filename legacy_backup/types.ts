...
export interface Vehicle {
  ...
  brand: string;
  model: string;
  version?: string; // e.g., "GT Line"
  year: number;
  plate: string; // Matricule
  ...
  mileage: number;
  agencyId: string;
  gpsId?: string; // Link to GPS module

  // Documents & Dates
  insuranceExpiry?: string; // ISO Date
  techVisitExpiry?: string; // ISO Date
  vignetteYear?: number;

  // Media & Files
  imageUrl: string;
  registrationDocUrl?: string; // Carte grise
...
export interface Reservation {
  ...
  vehicleId: string;
  clientId: string;
  clientName: string; // De-normalized for easier display
  clientPhone?: string;
